...
2. Asthma Emergency Department Visit Rate per 10,000 by County, 2014

* Data source: NYSDOH Health Data

```{r load_clean_asthma_ed_1, message = FALSE}
...
3. Cardiovascular Disease Hospitalization Rate per 10,000 by County, 2012-2014

* Data source: NYSDOH Health Data

```{r load_clean_cvd_1, message = FALSE}
